---
id: 075
title: "Pre-clarify research dispatch for brainstorm + explore"
status: draft
...
- Add "research evidence" annotation format to `references/output-format.md`
- Update `references/hybrid-classification-heuristic.md` with research-upgrade path
- Cost guard: skip research for Small entities with all-Confident assumptions
