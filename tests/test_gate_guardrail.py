...
def main():
    ...
    generate_first_officer(t, "gated-pipeline", mission="Gate guardrail test",
    ...
    t.check("generated first-officer contains gate guardrail",
            "NEVER self-approve" in fo_text)
    if "NEVER self-approve" not in fo_text:
